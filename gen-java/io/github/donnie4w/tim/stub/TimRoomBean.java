...
public class TimRoomBean implements org.apache.thrift.TBase<TimRoomBean, TimRoomBean._Fields>, java.io.Serializable, Cloneable, Comparable<TimRoomBean> {
  ...
  private static final org.apache.thrift.protocol.TField KIND_FIELD_DESC = new org.apache.thrift.protocol.TField("kind", org.apache.thrift.protocol.TType.I64, (short)7);
  ...
  private static final int __KIND_ISSET_ID = 1;
  private static final int __CREATETIME_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.FOUNDER,_Fields.MANAGERS,_Fields.COVER,_Fields.TOPIC,_Fields.LABEL,_Fields.GTYPE,_Fields.KIND,_Fields.CREATETIME,_Fields.EXTEND,_Fields.EXTRA};
  ...
  public TimRoomBean setKind(long kind) {
    this.kind = kind;
    setKindIsSet(true);
    return this;
  }
  ...
  public int hashCode() {
    ...
    if (isSetKind())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(kind);
