...
class TimMessageList
{
                ...
                case 2:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i140 = 0; $_i140 < $_size136; ++$_i140) {
                            $elem141 = null;
                            $elem141 = new \TimMessage();
                            $xfer += $elem141->read($input);
                            $this->messageList []= $elem141;
                        }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('TimMessageList');
        if ($this->id !== null) {
        ...
        if ($this->messageList !== null) {
            ...
            $xfer += $output->writeFieldBegin('messageList', TType::LST, 2);
            $output->writeListBegin(TType::STRUCT, count($this->messageList));
            foreach ($this->messageList as $iter142) {
